...
class Vehicle:
    ...
    def __init__(self, driver_id, location, cfg):
        ...
        self.reposition_target = True # 没有订单可接，进入下一次匹配
        ...
        self.pickup_path = [] # 接乘客的行驶路径
        self.pickup_path_length = []
        ...
        self.reposition_time = self.activate_time
        self.action = 0 # 采取的动作
    ...
    def reset_reposition(self):
        self.reposition_target = True

        
    # 重置
    def reset(self, activate_time, location):
