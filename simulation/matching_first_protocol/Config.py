...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.order_file= 'input/order_new.csv'
        self.shortest_path_file = 'input/shortest_path.csv'
        self.OD_pickle_path = 'input/OD.pickle'
        self.output_path = 'output/'
        ...
        # matching condition
        self.pickup_distance_threshold = 1000
        self.detour_distance_threshold = 1500
        self.delay_time_threshold = 300
        self.dead_value = 1e6
        self.reposition_time_threshold = 120
        self.discount_factor = 0.75
        self.Theta = [0]
        self.optimize_target = False
