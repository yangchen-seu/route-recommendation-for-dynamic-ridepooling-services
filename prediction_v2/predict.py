...
while iter_num < 20: 
    ...
    for node_id in node_dict.keys():
        ...
        for OD_index in W_node_id:
            if OD_index not in seekers.keys():
                continue
...
result.to_csv(params['prediction_results_file']+'{}_shortest_path/predicted_results_{}_shortest_path_{}'.format(PROB, PROB,params['date']))
